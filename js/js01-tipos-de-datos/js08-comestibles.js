...
/**
 *Una clase es una plantilla(molde) que servira para crear objetos. 
...
se recomienda qu el nombre sea un sustantivo en singular.
...
class Comestible {
    ...
    constructor( nombreEntrada ="alguito", sabor ="neutro" ){
        ...
        this.#fechaCreacion = new Date(); 
         console.log(`Soy ${this.nombre} y tengo vida :V, y mi sabor es ${this.sabor} `);    
}
