...
//============Array==============
/* 
 El tipo de array es un tipo de Objetoespecial
...
//Agregaar un elemento , en un índice que no existe
nombres[3] = "Yoli";
...
panes[0] = "Roles con pasas"; 

// push() : Agregar uno o más elementos
//  retorno: la longitud del arreglo
panes.push("Dona de Chocolate");
console.log( panes.push("Dona de Chocolate"));//2 *se imprime directamente en consola 
console.log( panes );
...
const numIndiceDelElemento = panes.indexOf("Roles con pasas");
...
// slice: estrae una sección de un array y devuelve los elementos extraidos.
...
//Pase por valor
let edadTan = 26; 
let edadDiana = edadTan; // La edad que se clona no se altera, permanece en 26
edadTan = 25;

const reiniciaEdad = (edad) => edad = 0;

reiniciaEdad ( edadTan );
...
let cars = autos;
autos.push("Jeppeta");
console.log( autos); //  ['Mazda', 'Vochito', 'Jeppeta']
console.log( cars ); // ['Mazda', 'Vochito', 'Jeppeta']
