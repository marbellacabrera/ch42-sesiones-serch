...
/*
 ...
 sintaxis:
    ...
    for(1 inicialización; 2 condición; 4 (actualización) O expresión final) {
       //  3 instrucciones
    }
 */
...
for( let i = 0; i < signosZodiacales.length ; i++ ){
    console.log( i, signosZodiacales[i] );  // 0 veces
...
const numerosSeleccionados = [5, 999, 17];
