...
public class TiposDeDatos {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Reglas para el nombre de las variables: - Se distingue entre minúsculas y
		 * mayúsculas - La longitud del nombre es ilimitada - Puedes utilizar cualquier
		 * caracter Unicode - La variable puede comenzar: > una letra ej. miVariable >
		 * signo de dolar $miVariable > caracter de subrayado(underscore) _miVariable -
		 * No se permiten espacios en el nombre - El nombre de la variable debe tener un
		 * contexto, ser claro
		...
		//El tipo byte es de 8 bits, almacena datos númericos enteros
		 ...
		 */
	    /*
	     * Paro obtener los rangos del tipo byte
		...
		System.out.println("Min value short:" + Short.MIN_VALUE );//-32768
		
		/*Tipo de dato int (integrar)
		 * Dato de 32 bits, almacena enteros
		 * Valor máximo y mínimo que puede representar (Wraper Integer) :
		 */
		...
		// ==================================================================
		  ...
		  System.out.println("Max value float: " + Float.MAX_VALUE); // 3.4028235E38 exponente a la 38
		  System.out.println("Min value float: " + Float.MIN_VALUE); //  1.4E-45 exponente a la -45
		...
		byte pozoleBurbuja = (byte)pozoleGrande1l; //agregar al lado de la variable el tipo de dato que estamos convirtiendo
		...
		//Obtener el primer dígito (8) De número a string
		...
		System.out.println("Mi último dígito usando residuo: " + (numSuerte %10));//8  Formato + rápido
		...
		int opB = 6; 
		//sumar 10 al operador A y lo reasigna a la variable
	   ...
	   //postdecremento: variable--;
		...
		int edadArantxa = 19;
		++edadArantxa;
		System.out.println( edadArantxa); // 20 ejemplo 1 sola linea
		
		//===================== ejemplo en + de 1 linea, cambiando el orden
		edadDiana = 25;
		int edadAImprimir;
		...
		edadAImprimir = edadArantxa++; //pos-incremento 
		System.out.println( edadAImprimir ); // 19

		//Ejercicio
		int x = 5; 
		int y = x++; // y=5; x=x+1 ->6 .. int y =x;  x = x + 1;
		...
		System.out.println( "valor de x: " +x); //6
		System.out.println( "valor de y: " +x); //6
