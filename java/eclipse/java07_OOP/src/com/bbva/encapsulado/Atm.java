...
public class Atm {
	...
	public Atm (String model, double amount){ //constructor = Atm es publico //firma
		this.model = model.toUpperCase();//siempre en Mayusculas con upperclass la clase
		this.amount = amount;
		this.serialNumber = ++counter; //+1
	}
	...
	public Atm() {
         ...
         */
		this("t-800", 1_000_00); //aqui inicializan los atributos
		//más lineas de código (se pueden tener)
	...
	// realizar set and get de amount
	...
	/**
	 * Sobre carga (Method overloading) de setAmount recibiendo
	 * un string	
	 * 
	 */
	//metodos constructores que se llamanx la clase
	public void setAmount(String amount ) {//lo mismo de arriba pero simplificado
		//this.amount = Double.parseDouble(amount); no respeta principio solid
