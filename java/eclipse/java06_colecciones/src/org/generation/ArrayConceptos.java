...
public class ArrayConceptos {
	...
	public static void main(String[] args) {
		...
		nt[] colores = new int[4]; // instanciar un array de 4 elementos de tipo int

		// Agregar array con 6 elementos de tipo Personas
		...
		// Agregando un color en el índice 0 (primer elemento)
				 ...
				 */
				//System.out.println("Leer color que no existe " + colores [10]); //marca error java no lo ejecuta
				...
				//for loop enhanced //itera todos los elementos 
				for(int color : colores ) {
					//System.out.println("Color: " + color );
				    System.out.printf("color: %06x %n", color); // es más lento 
				}
				...
				// Generar un arreglo de 2 dimensiones //arreglo de arreglos
